...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/zoidqc/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/zoidqc/wall3.jpg"
theme.font                                      = "Roboto Bold 10"
theme.taglist_font                              = "FontAwesome Regular"
theme.fg_normal                                 = "#FFFFFF"
theme.fg_focus                                  = "#0099CC"
theme.bg_focus                                  = "#24242400" --bar background 1 
theme.bg_normal                                 = "#24242477" --bar background 2 (Main background - Set opacity here)
theme.border_width                              = 1
theme.border_normal                             = "#252525"
theme.border_focus                              = "#0099CC"
theme.taglist_fg_focus                          = "#FFFFFF"
theme.tasklist_bg_normal                        = "#24242400"
theme.tasklist_fg_focus                         = "#4CB7DB" --focused window title text color
...
-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space3 .. "%b %d %H:%M "))
...
theme.volume = lain.widget.alsa({
    ...
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup("#FFFFFF", vlevel)))
    end
})
...
-- Separators
local spacing = wibox.widget.textbox('<span font="Roboto 7"> </span>')
...
local barcolor  = gears.color({
    ...
    from  = { 45, 0 },
    to    = { 45, 45 }, -- bar height
    stops = { {0, theme.bg_focus}, -- selected tag hightlight settings
              {0.5, "#00000066"},
              {0.8, theme.bg_focus} }
})
